	...
	return (
		<section
			className="
				...
				[radial-gradient(circle_at_top_left,#ecfdf3_0,transparent_60%),radial-gradient(circle_at_top_right,#e0f2fe_0,transparent_60%)]
			">
			<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
				<div className="grid gap-14 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)] lg:items-center">
					...
					<div className="max-w-xl">
						...
						<h1
							className="
								mt-4 text-[2.5rem] font-semibold tracking-tight text-slate-950
								sm:text-[2.9rem] lg:text-[3.1rem] lg:leading-[1.05]
							">
							The VR Group
						...
						<p className="mt-5 max-w-lg text-[0.95rem] leading-relaxed text-slate-600 sm:text-base">
					...
					<div className="w-full max-w-md justify-self-center lg:max-w-lg">
						<div
							...
							">
							{/* small accent bar */}
							<div className="mb-4 h-[3px] w-14 rounded-full bg-linear-to-r from-emerald-500 via-teal-500 to-sky-500" />
							...
							<div className="mt-5 rounded-2xl border border-slate-200/80 bg-slate-50/70 px-4 py-4">
								...
								{/* connecting line */}
								<div className="mx-auto mt-4 h-px w-24 bg-linear-to-r from-emerald-400 to-teal-400" />
